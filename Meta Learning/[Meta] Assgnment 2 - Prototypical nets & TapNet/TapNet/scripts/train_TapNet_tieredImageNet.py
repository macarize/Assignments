#Based on https://github.com/istarjun/TapNet
...
if __name__ == '__main__':
    ...
    #data load
    train_generator = tieredImageNetGenerator(image_file='../data/tieredImageNet/train_images.npz', label_file='../data/train_labels.pkl',
